...
ANCHOR_API void Anchor_SetErrorCallback(Anchor_Context *ctx, Anchor_ErrorCallback errorCallback);

ANCHOR_API Anchor_Status Anchor_GetErrorStatus(Anchor_Context *ctx);
ANCHOR_API const Anchor_Error *Anchor_GetError(Anchor_Context *ctx);
ANCHOR_API size_t Anchor_GetErrorMsg(Anchor_Context *ctx, char *buffer, size_t bufSize);
